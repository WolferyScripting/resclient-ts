...
find dist/esm \( -name "*.mjs" -o -name "*.d.mts" \) -exec sed -i -E 's#\./([A-Za-z0-9._/-]+)\.(t|j)s#./\1.m\2s#g' {} +
...
find dist/cjs \( -name "*.cjs" -o -name "*.d.cts" \) -exec sed -i -E 's#\./([A-Za-z0-9._/-]+)\.(t|j)s#./\1.c\2s#g' {} +
